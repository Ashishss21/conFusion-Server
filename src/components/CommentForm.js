...
import {Modal, ModalHeader, ModalBody, Row, Label, Button} from 'reactstrap'
     ...
     render(){
        return(
          <React.Fragment>
            ...
            <Button outline = "secondary" className="mx-auto mt-3" onClick={this.handleClick}><i className="fa fa-pencil mr-1" />Submit Comment</Button>
          </React.Fragment>
        );
    }
}
